...
import ValueBlockWrapper, {
    IconWrapper,
    ContentWrapper,
    ButtonWrapper,
} from './ValueBlock.style';
...
const ValueBlock = ({
    ...
    const Icon = icon && (
        <IconWrapper className="icon__wrapper" justify-content="center" {...iconStyle}>
            {icon}
        </IconWrapper>
    );
...
ValueBlock.propTypes = {
    ...
    /** Set icon position of the ValueBlock */

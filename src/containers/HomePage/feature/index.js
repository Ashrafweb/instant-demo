...
import { SectionHeader } from './feature.style';
import SectionWrapper, { TabArea } from './feature.style';

import { features } from 'common/data/Homepage';

const FeatureTab = () => {
    const { title, tab } = features;
    return (
        <SectionWrapper>
            <Container>
                <SectionHeader>
